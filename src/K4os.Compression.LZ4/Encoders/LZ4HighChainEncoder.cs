...
namespace K4os.Compression.LZ4.Encoders
{
	...
	using LZ4Context = LowLevelHighCompressor64.LZ4HC_CCtx_t;
	...
	public unsafe class LZ4HighChainEncoder: LZ4EncoderBase
	{
			...
			base(true, blockSize, extraBlocks)
		{
			...
			LowLevelHighCompressor64.LZ4_resetStreamHC(_context, (int) level);
		}
		...
		protected override int EncodeBlock(
			...
			LowLevelHighCompressor64.LZ4_compress_HC_continue(
				_context, source, target, sourceLength, targetLength);

		/// <inheritdoc />
		protected override int CopyDict(byte* target, int length) =>
			LowLevelHighCompressor64.LZ4_saveDictHC(_context, target, length);
	}
}
